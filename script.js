...
const DATA = {
  python: {
    desktop: [
      ...
      { title: "YouTube Viewer Trend Analytics", img: "yt_viewCountScreen.webp", desc: "I created a cross‑platform PyQt6 dashboard integrating the YouTube Data API to visualize channel view‑count trend.", code: "https://github.com/Naadir-Dev-Portfolio/Desktop-youtube-view-stats-dashboard/blob/main/main.py", demo: null, details: "https://github.com/Naadir-Dev-Portfolio/Desktop-youtube-view-stats-dashboard/blob/main/README.md" },
      { title: "PyQt6 Health Dashboard", img: "healthDashboardScreen.png", desc: "A Project where I've utilized OpenGL within a PyQt Health Dashboard for dynamic 3D model selectioand dynamic metrics.", code: "https://github.com/Naadir-Dev-Portfolio/Desktop-PyQt6-health-dashboard/blob/main/Ui_health.py", demo: null, details: "https://github.com/Naadir-Dev-Portfolio/Desktop-PyQt6-health-dashboard/blob/main/README.md" },
